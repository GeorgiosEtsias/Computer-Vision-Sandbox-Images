...
Scripts: GeneticAlgorithmSWCombination.m (main script executing the genetic algorithm iotimization), ObjectiveSWcombination.m (the objective function that was optimmized), gaplotbestcustom.m (ploting function)
