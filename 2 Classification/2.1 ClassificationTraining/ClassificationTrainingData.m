...
% Uses color images to derive data fit for classification  ANN training, 
% using the ANNClassifiationGenerator.m script or in conjuction with 
...
DATA=[R,G,Grey,stdGrey,BS];% optimum feature combination
...
clearvars -except AllDATA goalClass DATA